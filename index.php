    ...
    <div class="container-lg mt-5">
                           ...
                           <div class="col-12">
                               <div class="row">
                                   ...
                                   <div class="col-md-2 mt-1">
                                    <h4 class="text-danger">  <?php echo $jumlah; ?> </h4>
                                </div>
                               </div>
                           </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 mt-1">
                                        <h4>Faishal Rizal <i class="bi bi-patch-check-fill text-primary"></i></h4>
                                    </div>
                                    <div class="col-md-2 mt-1">
            ...
            <form method="post" action="index.php">
                <div class="row">
                    ...
                    <div class="col-md-1 col-2">
                        <button class="btn shadow-sm p-2 mb-2 mt-5 text-white" type="submit" name="filter" style="background-color: #ff9a1a;">Filter</button>
                    </div>
                    <div class="col-md-1 col-2">
                        <button class="btn shadow-sm p-2 mb-2 mt-5 text-white" type="submit" name="filter" style="background-color: #ff9a1a;"><i class="bi bi-arrow-clockwise"></i></button>
                    </div>  
                </div>
            </form> 
        </div>
        <hr>
            <h4 class="mt-2"><b>Data Surat Masuk</b></h4>
                <a href="tambah.php" class="btn p-2 mb-2 mt-2 text-white text-end" style="background-color: #ff9a1a;" >Tambah Data</a>
                    <?php 
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-3 text-center">
                                            ...
                                            <a href="detail.php?id=<?= $d['id']; ?>"class="btn shadow-sm p-1 mb-1 text-white text-end"style="background-color: #ff9a1a;">Detail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>     
